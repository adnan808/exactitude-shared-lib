...
export class migration1670609283411 implements MigrationInterface {
    name = 'migration1670609283411'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`users\` (\`id\` int NOT NULL AUTO_INCREMENT, \`resource_id\` varchar(255) NOT NULL, \`is_deleted\` tinyint NOT NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deleted_at\` datetime NOT NULL, \`email\` varchar(255) NOT NULL, \`firstname\` varchar(255) NOT NULL, \`lastname\` varchar(255) NOT NULL, \`login_attempts\` tinyint NOT NULL, \`last_login_at\` datetime NOT NULL, \`is_test_user\` tinyint NOT NULL, \`referral_token\` varchar(255) NOT NULL, \`is_active\` tinyint NOT NULL, UNIQUE INDEX \`IDX_4a559911dbcd6c035c1cd96463\` (\`resource_id\`), UNIQUE INDEX \`IDX_97672ac88f789774dd47f7c8be\` (\`email\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
