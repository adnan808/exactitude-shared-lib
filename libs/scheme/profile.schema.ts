...
const ProfileSubDocSchema = new Schema<ProfileSubDoc>(
  {
    ...
    is_intern: { type: Boolean, index: true, default: false },
    is_MBA_profile: { type: Boolean, index: true, default: false },
    is_past_MBA_profile: { type: Boolean, index: true, default: false },
    mbaAssociateStartedWorking: { type: Date },
    mbaType: { type: String, index: true },
    dateOfGraduation: { type: Date },
    isBuySide: { type: Boolean, index: true, default: false },
    isSellSide: { type: Boolean, index: true, default: false },
  },
  { _id: false },
);
